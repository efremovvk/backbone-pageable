  ...
  */
  var PageableCollection = Backbone.PageableCollection = Backbone.Collection.extend({
    ...
    */
    ...
    /**
       @property {"server"|"client"|"infinite"|"endless"} [mode="server"] The mode of
       operations for this collection. `"server"` paginates on the server-side,
       `"client"` paginates on the client-side and `"infinite"` paginates on the
       server-side for APIs that do not support `totalRecords`, `"endless"` like
       server but adding the collection (not fullCollection)
    */
    mode: "server",
    ...
    */
    constructor: function (models, options) {
      ...
      if ((mode != "server" && mode != "endless") && state.totalRecords == null && !_isEmpty(models)) {
    ...
    */
    ...
    /**
       ...
       @param {"server"|"client"|"infinite"|"endless"} [mode] The mode to switch to.
    ...
    */
    switchMode: function (mode, options) {
      ...
      if (!_contains(["server", "client", "infinite", "endless"], mode)) {
      ...
      if ( (mode != "server" && mode != "endless") && !fullCollection) {
      ...
      else if ((mode == "server" || mode == "endless" ) && fullCollection) {
        _each(_keys(handlers), function (event) {
    ...
    */
    getPage: function (index, options) {
      ...
      if (mode == "endless" && options.to != firstPage) options.remove = false;
